...
<body>
  <header>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
      <a href="homepage.php" class="navbar-brand"> <span class="navbar-text">TanFlix</span> </a>
      ...
      <ul class="navbar-nav">
        ...
        echo "<li class='nav-item'> <a href='admin-account.php' class='nav-link'>Account</a> </li>
